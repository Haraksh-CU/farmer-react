                ...
                <div className="main-footer">
                    <div className="footer-child-container">
                        <div className="footer-child">
                            ...
                            <div className="icons">
                                <i className="fa-brands fa-square-facebook fa-4x icon" style={{ color: "#f5d1d0" }}></i>
                                <i className="fa-brands fa-instagram fa-4x" style={{ color: "#f5d1d0" }}></i>
                                <i className="fa-brands fa-square-twitter fa-4x icon" style={{ color: "#f5d1d0" }}></i>
                            </div>
                        </div>
                        <div className="footer-child">
